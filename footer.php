...
<h3>Shopping Portal</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> An resale company aimed at selling gift cards and coupons at cheaper prices.</p>
...
<div class="contact-timing">
	<div class="module-heading">
		<h4 class="module-title">Operations</h4>
	</div><!-- /.module-heading -->
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+91) 9082307542<br>(+91) 9999599595</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">giftcardsandcoupons@gmail.com</a></span>
                </div>
            </li>
